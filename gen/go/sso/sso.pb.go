...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\vaccessToken\x18\x02 \x01(\tR\vaccessToken2p\n" +
	"\x04Auth\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x126\n" +
	"\aRefresh\x12\x14.auth.RefreshRequest\x1a\x15.auth.RefreshResponseB\x13Z\x11hopt.sso.v1;ssov1b\x06proto3"
...
var file_sso_sso_proto_depIdxs = []int32{
	...
	0, // 1: auth.Auth.Refresh:input_type -> auth.RefreshRequest
	3, // 2: auth.Auth.Login:output_type -> auth.LoginResponse
	1, // 3: auth.Auth.Refresh:output_type -> auth.RefreshResponse
